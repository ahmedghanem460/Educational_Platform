...
import { useUserDeUtails } from '../../context/UserDetailContext'
...
//     if (!courseIdea.trim()) {
//       Alert.alert('Input Required', 'Please enter a topic to generate courses.');
//       return;
//     }
...
//       try {
//         const parsedJson = JSON.parse(res); // First, parse the AI's string response
//         const formatted = JSON.stringify(parsedJson, null, 2); // Then, stringify for pretty display
//         setResult(formatted);
//       } catch (jsonError) {
//         console.warn('Failed to parse JSON response from AI:', jsonError);
//         console.warn('Raw AI response was:', res);
//         setResult(res); // Display raw response if parsing fails
//         Alert.alert(
//           'Response Format Error',
//           'The AI response was not in the expected JSON format. Raw response displayed.'
//         );
//       }
//     } catch (err) {
...
//       Alert.alert(
//         'Generation Failed',
//         `Failed to generate topic. ${err.message || 'Please try again.'}`
//       );
//     } finally {
//       setLoading(false);
//     }
...
//         What course do you want to create (ex. Learn Python, Digital Marketing, 10th Science Chapters, etc...)
//       </Text>
...
//       {loading && (
//         <ActivityIndicator size="large" color="#FFA33D" style={styles.loader} />
//       )}

//       {result ? (
//         <>
//           <View style={styles.resultContainer}>
//             <Text style={styles.resultLabel}>Generated Courses:</Text>
